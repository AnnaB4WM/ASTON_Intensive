...
import org.example.services.UserDaoCRUDService;
...
public class HibernateConsoleRunner {
    ...
    private static final UserDaoCRUDService UserDaoCRUDService = new UserDaoCRUDService();
    ...
    private static void getUserById() {
        ...
        User user = UserDaoCRUDService.get(id);
        if (user != null) {
    ...
    private static void getAllUsers() {
        Collection<User> users = UserDaoCRUDService.getAll();
    ...
    private static void updateUser() {
        ...
        if (user != null) {
            ...
            UserDaoCRUDService.update(user);
